        ...
        <nav class="bg-white shadow-sm sticky top-0 z-40">
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex items-center justify-between h-16">
                   <!-- Logo & Brand Name -->
                    <RouterLink to="/" class="flex items-center gap-2 h-16 px-1">
                        ...
                        />
                        <!-- Teks Brand: "Litera" Hitam, "See" Biru -->
                        <span class="text-xl font-bold tracking-tight flex items-center">
                            <span class="text-gray-900">Litera</span>
                            <span class="text-primary-600">See</span>
                        </span>
                    </RouterLink>
                        ...
                        <template v-if="isAuthenticated">
                            ...
                            <div class="relative">
                                <button @click="userMenuOpen = !userMenuOpen" class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100">
                                    <img :src="user?.avatar_url" :alt="user?.name" class="w-8 h-8 rounded-full bg-gray-200 object-cover" />
